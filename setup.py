...
## Constants
CODE_DIRECTORY = 'archimate2mongodb'
DOCS_DIRECTORY = 'docs'
...
#
#     from archimate2mongodb import metadata
#
# However, when we do this, we also import `archimate2mongodb/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'archimate2mongodb_cli = archimate2mongodb.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'archimate2mongodb_gui = archimate2mongodb.gui:entry_point'
        # ]
    }
)
